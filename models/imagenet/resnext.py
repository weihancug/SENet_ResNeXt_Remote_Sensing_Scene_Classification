...
__all__ = ['resnext18','resnext50', 'resnext101', 'resnext152']
...
def resnext18(baseWidth, cardinality,num_class):
    
#   construt resNetx-29
    model = ResNeXt(baseWidth,cardinality,[2,2,2,2],num_class)
    return model 

def resnext50(baseWidth, cardinality, num_class):
    """
    Construct ResNeXt-50.
    """
    model = ResNeXt(baseWidth, cardinality, [3, 4, 6, 3], num_class)
    return model


def resnext101(baseWidth, cardinality,num_class):
    """
    Construct ResNeXt-101.
    """
    model = ResNeXt(baseWidth, cardinality, [3, 4, 23, 3], num_class)
    return model


def resnext152(baseWidth, cardinality,num_class):
    """
    Construct ResNeXt-152.
    """
    model = ResNeXt(baseWidth, cardinality, [3, 8, 36, 3], num_class)
    return model
